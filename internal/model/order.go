...
type OrderPay string

const (
	OrderPayUnpaid   OrderPay = "0"
	OrderPayAlipay   OrderPay = "1"
	OrderPayWechat   OrderPay = "2"
	OrderPayBankCard OrderPay = "3"
)
...
type Order struct {
	...
	OrderPay           OrderPay  `gorm:"type:enum('0','1','2','3');not null;default:'1';comment:支付方式  0未支付 1支付宝  2微信  3银行卡"`
	IsSend             IsSend    `gorm:"type:enum('是','否');not null;default:'否';comment:订单是否已经发货"`
	...
	PayStatus          PayStatus `gorm:"type:enum('0','1');not null;default:'0';comment:订单状态： 0未付款、1已付款"`
